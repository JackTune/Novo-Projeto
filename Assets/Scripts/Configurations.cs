...
public class Configurations : MonoBehaviour {
    ...
    public Button BotaoOpcoes, BotaoSair, BotaoJogar;
    [Space(20)]
    public Slider BarraVolume;
    public Toggle CaixaModoJanela;
    public Dropdown Resolucoes, Qualidades;
    public Button BotaoVoltar, BotaoSalvarPref;
    public Text textVol, textResolutions, textQualities;
    ...
    private void Opcoes(bool ativarOP)
    {
        ...
        textResolutions.gameObject.SetActive(ativarOP);
        textQualities.gameObject.SetActive(ativarOP);
    ...
    // Se clicar em sair, fecha o jogo
    private void Sair()
    {
        Application.Quit();
    }
